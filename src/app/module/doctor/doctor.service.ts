...
const applyAsDoctorIntoDB = async (
    ...
    // =========================================================
    // 3. Upload doctor`s resume to Cloudinary
    // =========================================================
    ...
    // =========================================================
    // 4. Upload doctor`s additional files
    // =========================================================
    ...
    // =========================================================
    // 11. Return created doctor application
    // =========================================================

    return doctorApplication;
};

const verifyDoctorEmailIntoDB = async (payload: IVerifyDoctorEmailPayload) => {
...
const approveDoctorIntoDB = async (
...
const getAllDoctorsIntoDB = async (query: IQuery) => {
    ...
    if (query.verificationStatus) {
        andConditions.push({
            verificationStatus:
                query.verificationStatus as DoctorVerificationStatus,
        });
    }
...
const updateDoctorProfileIntoDB = async (
...
const getAvailableDoctorByTodaysScheduleIntoDB = async (query: IQuery) => {
    const limit = query.limit ? Number(query.limit) : 10;
    const page = query.page ? Number(query.page) : 1;
    const skip = (page - 1) * limit;
    const sortBy = query.sortBy ? query.sortBy : 'createdAt';
...
const getAllDoctorsListPublicIntoDB = async (query: IQuery) => {
    const limit = query.limit ? Number(query.limit) : 10;
    const page = query.page ? Number(query.page) : 1;
    const skip = (page - 1) * limit;
    const sortBy = query.sortBy ? query.sortBy : 'createdAt';
...
const getSingleDoctorPublicProfileIntoDB = async (doctorId: string) => {
...
export const DoctorServices = {
    applyAsDoctorIntoDB,
    verifyDoctorEmailIntoDB,
    approveDoctorIntoDB,
    getAllDoctorsIntoDB,
    updateDoctorProfileIntoDB,
    getAvailableDoctorByTodaysScheduleIntoDB,
    getAllDoctorsListPublicIntoDB,
    getSingleDoctorPublicProfileIntoDB,
};
